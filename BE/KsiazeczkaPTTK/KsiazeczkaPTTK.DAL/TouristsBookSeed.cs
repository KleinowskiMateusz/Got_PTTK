...
namespace KsiazeczkaPttk.DAL
{
    public static class TouristsBookSeed
    {
        ...
        private static async Task SeedFromCode(TouristsBookContext context)
        {
            ...
            {
                new Confirmation { Id = 101, Url = "b95fc8cd-a474-44f2-968a-6da2118c1f6e_rusinowaPolana.jpg", Date = new System.DateTime(2022, 5, 21, 12, 10, 0), TerrainPointId = punktyTerenowePubliczne[0].Id, TerrainPoint = punktyTerenowePubliczne[0], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
                new Confirmation { Id = 102, Url = "770f1809-59d5-46ba-9777-7095457a5884_dolinaPanczyca.jpg", Date = new System.DateTime(2022, 5, 21, 14, 10, 0), TerrainPointId = punktyTerenowePrywatne[0].Id, TerrainPoint = punktyTerenowePrywatne[0], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
                new Confirmation { Id = 103, Url = "6d945f8f-19ae-4d63-bd2c-2f3b834d36f6_gesiaSzyja.jpg", Date = new System.DateTime(2022, 5, 21, 15, 50, 0), TerrainPointId = punktyTerenowePubliczne[2].Id, TerrainPoint = punktyTerenowePubliczne[2], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
                new Confirmation { Id = 104, Url = "cd467e9c-a530-45b7-a0f2-4595fad24bfd_rowienWaksmundzka.jpg", Date = new System.DateTime(2022, 5, 21, 17, 10, 0), TerrainPointId = punktyTerenowePubliczne[3].Id, TerrainPoint = punktyTerenowePubliczne[3], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
                new Confirmation { Id = 105, Url = "263f37d7-38d3-4747-9335-1812f5fb3a90_psiaTrawka.jpg", Date = new System.DateTime(2022, 5, 21, 17, 50, 0), TerrainPointId = punktyTerenowePubliczne[4].Id, TerrainPoint = punktyTerenowePubliczne[4], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
                new Confirmation { Id = 106, Url = "75521f1b-40f9-4ce3-a0ab-8ab5baf282e8_schroniskoHalaGasienicowa.jfif", Date = new System.DateTime(2022, 5, 21, 18, 45, 0), TerrainPointId = punktyTerenowePubliczne[9].Id, TerrainPoint = punktyTerenowePubliczne[9], IsAdministration = false, Type = Domain.Enums.ConfirmationType.Image },
            };
